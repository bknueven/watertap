...
class TestWalnutShellFilterZO_w_default_removal:
    ...
    def test_load_parameters(self, model):
        data = model.db.get_unit_operation_parameters("walnut_shell_filter")
...
def test_costing():
    ...
    assert isinstance(m.fs.costing.walnut_shell_filter.capital_b_parameter, Var)
    assert isinstance(m.fs.costing.walnut_shell_filter.reference_state, Var)
