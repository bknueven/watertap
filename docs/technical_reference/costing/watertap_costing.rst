...
Maintenance-labor-chemical factor                 :math:`f_{mlc}`     ``factor_maintenance_labor_chemical``    0.06            Maintenance, labor, and chemical factor (fraction of equipment cost / year)
